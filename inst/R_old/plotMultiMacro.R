plotMultiMacro <- function(file1, file2, file3, mainTitle, subTitle, drugStart, timePeriods)
{
	...
	plotMacro(yset, c("time", "Ma", "Mi", "Mr"), mainTitle, subTitle, "Cells/mL", drugStart)
}